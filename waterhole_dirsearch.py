...
class AdvancedWebCrawler:
    def __init__(self, max_workers=10, timeout=10, retry_count=1, dirsearch_max_rate=9, max_dirsearch_workers=40):
        """
        初始化爬蟲
...
def main():
    ...
    crawler = AdvancedWebCrawler(
        ...
        timeout=10,                  # 請求超時時間
        retry_count=1,               # 重試次數
        dirsearch_max_rate=9,       # dirsearch 最大速率
        max_dirsearch_workers=40     # dirsearch 最大並行數
    )
